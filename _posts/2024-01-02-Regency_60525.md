...
<div class="centered-text">
  <div class="typing-effect" style="font-size: 18px;">
    <h1> Property Diversity & Competitition </h1>     
  </div>
</div> 

 
 <div class="slide-in-left">
  <img src="{{ 'assets/images/Regency_60525_diversity.svg' | relative_url }}" alt="Diversity Chart" class="img-responsive">
</div>

<!-- Slide-in SVG image -->
<div class="slide-in-left">
  <img src="{{ 'assets/images/Regency_60525_elasticity.svg' | relative_url }}" alt="Elasticity Chart" class="img-responsive">
</div>
